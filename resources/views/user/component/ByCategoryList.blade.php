...
<div class="mt-5">
    <div class="container my-5">
        <div class="row" id="byCategoryList">
...
<script>
    async function ByCategory() {
        ...
        let res = await axios.get(`/api/products/?category_id=${id}`);
        res = res.data[0];

        if (res.length === 0) {
            return $("#byCategoryList").append(`<div class="col-12 text-center"><h3>No Product Found</h3></div>`);
        }
        ...
        $("#CatName").text(res[0]['category']['name']);
    }
</script>
